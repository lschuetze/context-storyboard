 ...
 * @generated
 */
public class Crom_l1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Crom_l1Package.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1Package.MODEL_ELEMENT: {
			...
			case Crom_l1Package.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1Package.RIGID_TYPE: {
			...
			case Crom_l1Package.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1Package.PARAMETER: {
			...
			case Crom_l1Package.NATURAL_TYPE: {
				...
				if (result == null) result = casePlayer(naturalType);
			...
			case Crom_l1Package.ROLE_TYPE: {
				...
				if (result == null) result = casePlayer(roleType);
				if (result == null) result = caseNamedElement(roleType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1Package.FULFILLMENT: {
			...
			case Crom_l1Package.INHERITANCE: {
			...
			case Crom_l1Package.NATURAL_INHERITANCE: {
			...
			case Crom_l1Package.RELATION_TARGET: {
			...
			case Crom_l1Package.PART: {
				Part part = (Part)theEObject;
				T result = casePart(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Crom_l1Package.COMPARTMENT_TYPE: {
				...
				if (result == null) result = casePlayer(compartmentType);
