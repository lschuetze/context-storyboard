...
/**
 * This is the item provider adapter for a {@link metamodel.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_first_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_first_feature", "_UI_Relation_type"),
				 MetamodelPackage.Literals.RELATION__FIRST,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSecondPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relation_second_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relation_second_feature", "_UI_Relation_type"),
				 MetamodelPackage.Literals.RELATION__SECOND,
				 true,
				 false,
				 true,
				 null,
