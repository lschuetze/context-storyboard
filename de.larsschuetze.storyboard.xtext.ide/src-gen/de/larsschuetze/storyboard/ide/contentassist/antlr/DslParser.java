 ...
 */
package de.larsschuetze.storyboard.ide.contentassist.antlr;

import com.google.inject.Inject;
import de.larsschuetze.storyboard.ide.contentassist.antlr.internal.InternalDslParser;
...
public class DslParser extends AbstractContentAssistParser {
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGuardValueAccess().getAlternatives(), "rule__GuardValue__Alternatives");
					put(grammarAccess.getStoryPatternPortAccess().getAlternatives(), "rule__StoryPatternPort__Alternatives");
					put(grammarAccess.getRoleNodeAccess().getAlternatives_0(), "rule__RoleNode__Alternatives_0");
					put(grammarAccess.getRewriteRoleNodeAccess().getAlternatives(), "rule__RewriteRoleNode__Alternatives");
					put(grammarAccess.getConditionRoleNodeAccess().getAlternatives(), "rule__ConditionRoleNode__Alternatives");
					...
					put(grammarAccess.getStoryboardAccess().getGroup(), "rule__Storyboard__Group__0");
					put(grammarAccess.getStartNodeAccess().getGroup(), "rule__StartNode__Group__0");
					put(grammarAccess.getEndNodeAccess().getGroup(), "rule__EndNode__Group__0");
					...
					put(grammarAccess.getStoryPatternNodeAccess().getGroup(), "rule__StoryPatternNode__Group__0");
					put(grammarAccess.getRoleNodeAccess().getGroup(), "rule__RoleNode__Group__0");
					put(grammarAccess.getRemoveRoleNodeAccess().getGroup(), "rule__RemoveRoleNode__Group__0");
					put(grammarAccess.getRenewRoleNodeAccess().getGroup(), "rule__RenewRoleNode__Group__0");
					put(grammarAccess.getAddRoleNodeAccess().getGroup(), "rule__AddRoleNode__Group__0");
					put(grammarAccess.getProhibitedRoleNodeAccess().getGroup(), "rule__ProhibitedRoleNode__Group__0");
					put(grammarAccess.getPlayRoleNodeAccess().getGroup(), "rule__PlayRoleNode__Group__0");
					...
					put(grammarAccess.getStoryboardAccess().getImportedEventsAssignment_2(), "rule__Storyboard__ImportedEventsAssignment_2");
					put(grammarAccess.getStoryboardAccess().getNameAssignment_5(), "rule__Storyboard__NameAssignment_5");
					put(grammarAccess.getStoryboardAccess().getElementsAssignment_6(), "rule__Storyboard__ElementsAssignment_6");
					put(grammarAccess.getStartNodeAccess().getNameAssignment_1(), "rule__StartNode__NameAssignment_1");
					put(grammarAccess.getEndNodeAccess().getNameAssignment_1(), "rule__EndNode__NameAssignment_1");
					put(grammarAccess.getEventAccess().getEventTypeAssignment_1(), "rule__Event__EventTypeAssignment_1");
					...
					put(grammarAccess.getTransitionAccess().getEventAssignment_4(), "rule__Transition__EventAssignment_4");
					put(grammarAccess.getTransitionAccess().getGuardAssignment_5(), "rule__Transition__GuardAssignment_5");
					put(grammarAccess.getTransitionAccess().getSourceAssignment_7(), "rule__Transition__SourceAssignment_7");
					put(grammarAccess.getTransitionAccess().getSourcePortAssignment_8_1(), "rule__Transition__SourcePortAssignment_8_1");
					put(grammarAccess.getTransitionAccess().getTargetAssignment_10(), "rule__Transition__TargetAssignment_10");
					put(grammarAccess.getGuardAccess().getGuardAssignment_1(), "rule__Guard__GuardAssignment_1");
					put(grammarAccess.getStoryPatternNodeAccess().getNameAssignment_1(), "rule__StoryPatternNode__NameAssignment_1");
					put(grammarAccess.getStoryPatternNodeAccess().getClassNameAssignment_4(), "rule__StoryPatternNode__ClassNameAssignment_4");
					put(grammarAccess.getStoryPatternNodeAccess().getRoleReconfigurationsAssignment_6(), "rule__StoryPatternNode__RoleReconfigurationsAssignment_6");
					put(grammarAccess.getRoleNodeAccess().getCompartmentNameAssignment_2(), "rule__RoleNode__CompartmentNameAssignment_2");
					put(grammarAccess.getRemoveRoleNodeAccess().getNameAssignment_1(), "rule__RemoveRoleNode__NameAssignment_1");
					put(grammarAccess.getRenewRoleNodeAccess().getNameAssignment_1(), "rule__RenewRoleNode__NameAssignment_1");
					put(grammarAccess.getAddRoleNodeAccess().getNameAssignment_1(), "rule__AddRoleNode__NameAssignment_1");
					put(grammarAccess.getProhibitedRoleNodeAccess().getNameAssignment_1(), "rule__ProhibitedRoleNode__NameAssignment_1");
					put(grammarAccess.getPlayRoleNodeAccess().getNameAssignment_1(), "rule__PlayRoleNode__NameAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			...
			typedParser.entryRuleStoryboard();
