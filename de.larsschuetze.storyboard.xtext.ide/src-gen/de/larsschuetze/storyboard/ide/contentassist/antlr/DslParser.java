		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRoleNodeAccess().getAlternatives(), "rule__RoleNode__Alternatives");
					...
					put(grammarAccess.getTransitionAccess().getSourceAssignment_4(), "rule__Transition__SourceAssignment_4");
					put(grammarAccess.getTransitionAccess().getSourcePortAssignment_5_1(), "rule__Transition__SourcePortAssignment_5_1");
					put(grammarAccess.getTransitionAccess().getTargetAssignment_7(), "rule__Transition__TargetAssignment_7");
					put(grammarAccess.getTransitionAccess().getEventAssignment_9(), "rule__Transition__EventAssignment_9");
