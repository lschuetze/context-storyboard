 ...
 * <ul>
 *   <li>{@link de.larsschuetze.metamodel.JoinNode#getJoinSpec <em>Join Spec</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.larsschuetze.metamodel.MetamodelPackage#getJoinNode()
 * @model
 * @generated
 */
public interface JoinNode extends ControlNode {
	 ...
	 * @see de.larsschuetze.metamodel.MetamodelPackage#getJoinNode_JoinSpec()
	...
	/**
	 * Sets the value of the '{@link de.larsschuetze.metamodel.JoinNode#getJoinSpec <em>Join Spec</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
