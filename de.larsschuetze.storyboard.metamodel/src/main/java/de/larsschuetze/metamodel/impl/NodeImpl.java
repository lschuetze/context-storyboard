 ...
 * <ul>
 *   <li>{@link de.larsschuetze.metamodel.impl.NodeImpl#getIn <em>In</em>}</li>
 *   <li>{@link de.larsschuetze.metamodel.impl.NodeImpl#getOut <em>Out</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public EList<Edge> getIn() {
		if (in == null) {
			in = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MetamodelPackage.NODE__IN, MetamodelPackage.EDGE__TARGET);
		}
		return in;
	}
	...
	public EList<Edge> getOut() {
		if (out == null) {
			out = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MetamodelPackage.NODE__OUT, MetamodelPackage.EDGE__SOURCE);
		}
		return out;
	}
