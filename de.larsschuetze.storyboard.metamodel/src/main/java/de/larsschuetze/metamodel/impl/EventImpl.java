 ...
 * <ul>
 *   <li>{@link de.larsschuetze.metamodel.impl.EventImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EventImpl extends MinimalEObjectImpl.Container implements Event {
	 ...
	 * @generated
	 */
	public Class callMethod(String name, EList<Class> parameters) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MetamodelPackage.EVENT___CALL_METHOD__STRING_ELIST:
				return callMethod((String)arguments.get(0), (EList<Class>)arguments.get(1));
		}
