...
@after {
	...
	(
		...
		{
			$current = $this_StoryPatternNode_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleGuardValue returns [String current=null]:
	{ newCompositeNode(grammarAccess.getGuardValueRule()); }
	iv_ruleGuardValue=ruleGuardValue
	{ $current=$iv_ruleGuardValue.current.getText(); }
	EOF;

// Rule GuardValue
ruleGuardValue returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleStoryPatternPort returns [String current=null]:
	{ newCompositeNode(grammarAccess.getStoryPatternPortRule()); }
	iv_ruleStoryPatternPort=ruleStoryPatternPort
	{ $current=$iv_ruleStoryPatternPort.current.getText(); }
	EOF;

// Rule StoryPatternPort
ruleStoryPatternPort returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleFailurePort returns [String current=null]:
	{ newCompositeNode(grammarAccess.getFailurePortRule()); }
	iv_ruleFailurePort=ruleFailurePort
	{ $current=$iv_ruleFailurePort.current.getText(); }
	EOF;

// Rule FailurePort
ruleFailurePort returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleSuccessPort returns [String current=null]:
	{ newCompositeNode(grammarAccess.getSuccessPortRule()); }
	iv_ruleSuccessPort=ruleSuccessPort
	{ $current=$iv_ruleSuccessPort.current.getText(); }
	EOF;

// Rule SuccessPort
ruleSuccessPort returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
...
entryRuleStoryPatternNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStoryPatternNodeRule()); }
	iv_ruleStoryPatternNode=ruleStoryPatternNode
	{ $current=$iv_ruleStoryPatternNode.current; }
	EOF;

// Rule StoryPatternNode
ruleStoryPatternNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRoleNodeRule()); }
	iv_ruleRoleNode=ruleRoleNode
	{ $current=$iv_ruleRoleNode.current; }
	EOF;

// Rule RoleNode
ruleRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		(
			...
			{
				$current = $this_ConditionRoleNode_0.current;
				afterParserOrEnumRuleCall();
			}
			    |
			{
			...
			{
				$current = $this_RewriteRoleNode_1.current;
				afterParserOrEnumRuleCall();
			}
		)
		otherlv_2='in'
...
entryRuleRewriteRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRewriteRoleNodeRule()); }
	iv_ruleRewriteRoleNode=ruleRewriteRoleNode
	{ $current=$iv_ruleRewriteRoleNode.current; }
	EOF;

// Rule RewriteRoleNode
ruleRewriteRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_AddRoleNode_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_RenewRoleNode_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_RemoveRoleNode_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRemoveRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRemoveRoleNodeRule()); }
	iv_ruleRemoveRoleNode=ruleRemoveRoleNode
	{ $current=$iv_ruleRemoveRoleNode.current; }
	EOF;

// Rule RemoveRoleNode
ruleRemoveRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRenewRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRenewRoleNodeRule()); }
	iv_ruleRenewRoleNode=ruleRenewRoleNode
	{ $current=$iv_ruleRenewRoleNode.current; }
	EOF;

// Rule RenewRoleNode
ruleRenewRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAddRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAddRoleNodeRule()); }
	iv_ruleAddRoleNode=ruleAddRoleNode
	{ $current=$iv_ruleAddRoleNode.current; }
	EOF;

// Rule AddRoleNode
ruleAddRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConditionRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConditionRoleNodeRule()); }
	iv_ruleConditionRoleNode=ruleConditionRoleNode
	{ $current=$iv_ruleConditionRoleNode.current; }
	EOF;

// Rule ConditionRoleNode
ruleConditionRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_PlayRoleNode_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ProhibitedRoleNode_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleProhibitedRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getProhibitedRoleNodeRule()); }
	iv_ruleProhibitedRoleNode=ruleProhibitedRoleNode
	{ $current=$iv_ruleProhibitedRoleNode.current; }
	EOF;

// Rule ProhibitedRoleNode
ruleProhibitedRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRulePlayRoleNode returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPlayRoleNodeRule()); }
	iv_rulePlayRoleNode=rulePlayRoleNode
	{ $current=$iv_rulePlayRoleNode.current; }
	EOF;

// Rule PlayRoleNode
rulePlayRoleNode returns [EObject current=null]
@init {
	enterRule();
}
@after {
