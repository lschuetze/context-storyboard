...
import de.larsschuetze.storyboard.formatting2.DslFormatter;
import de.larsschuetze.storyboard.jvmmodel.DslJvmModelInferrer;
import de.larsschuetze.storyboard.parser.antlr.DslAntlrTokenFileProvider;
import de.larsschuetze.storyboard.parser.antlr.DslParser;
import de.larsschuetze.storyboard.parser.antlr.internal.InternalDslLexer;
import de.larsschuetze.storyboard.scoping.DslScopeProvider;
import de.larsschuetze.storyboard.serializer.DslSemanticSequencer;
import de.larsschuetze.storyboard.serializer.DslSyntacticSequencer;
import de.larsschuetze.storyboard.services.DslGrammarAccess;
import de.larsschuetze.storyboard.validation.DslValidator;
...
public abstract class AbstractDslRuntimeModule extends DefaultXbaseRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "de/larsschuetze/storyboard/Dsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.larsschuetze.storyboard.Dsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("casb");
	}
